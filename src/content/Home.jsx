    ...
    <div className="w-full flex flex-row h-full">
      <div className="flex flex-col   flex-1 ">
        <div className="absolute mmd:mt-4  ">
          <h1 className="md:text-3xl px-6 mt-8  font-bold text-white  mmd:mt-12 mmd:ml-8 mmd:text-5xl mlg:text-6xl">
            VIT CHENNAI
          </h1>
          <h1 className="md:text-3xl px-6 font-bold text-white  mmd:mt-2  mmd:ml-8   mmd:text-5xl mlg:text-6xl ">
            CLUB EVENTS!
          </h1>
        </div>
