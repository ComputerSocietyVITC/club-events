        ...
        <div className="ml-16 text-white mr-16">
          ...
          <div className="flex flex-wrap content-start space-x-8">
            ...
            <div>
              ...
              <div className="pt-3" />
              <input className="w-full rounded-full text-black" type="date" id="Date" name="Date" />
            </div>
          </div>
          <br />
          <div className="flex flex-wrap content-start space-x-8">
          ...
          <div>
            ...
            <div className="pt-3" />
            <input
              className=" w-full rounded h-24 text-black "
              type="text"
              id="info"
              name="info"
              value={info}
          ...
          {show ? (
            ...
            <BsToggle2Off
              size="50px"
              className="cursor-pointer transform rotate-0  "
              onClick={handleClick}
            />
          )}
          <br />
